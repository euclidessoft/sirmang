 ...
 */
class ActivitecelluleRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, Activitecellule::class);
    }

    // /**
    //  * @return Activitecellule[] Returns an array of Activitecellule objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Activitecellule
    {
        return $this->createQueryBuilder('a')
            ->andWhere('a.exampleField = :val')
            ->setParameter('val', $value)
